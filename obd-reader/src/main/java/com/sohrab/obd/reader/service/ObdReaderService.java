...
//
//                    if (!deviceFound) {
//                        sendBroadcast(ACTION_OBD_CONNECTION_STATUS, getString(R.string.adapter_not_found));
//                    }
//                }
//            }
//        } catch (Exception e) {
...
//        }
        ...
        try {
            if (!isConnected && ObdPreferences.get(getApplicationContext()).getServiceRunningStatus()) {
                if (mBluetoothAdapter != null) {
                    boolean deviceFound = false;
                    ...
                    final Thread newThread = new Thread(new Runnable() {
                        ...
                        public void run() {
                            try {
                                ...
                                // this thread is required because in Head unit command.run method block infinitly ,
...
*/
                ...
                sendBroadcast(ACTION_OBD_CONNECTION_STATUS, getString(R.string.obd2_adapter_not_found));
/*
    ...
    private void executeCommand() {
        ...
        while (mSocket != null && mSocket.isConnected() && commands.size() > count && isConnected && ObdPreferences.get(getApplicationContext()).getServiceRunningStatus()) {
            ...
            try {
                ...
                if (!TextUtils.isEmpty(e.getMessage()) && (Objects.equals(e.getMessage(), "Broken pipe") || Objects.equals(e.getMessage(), "Connection reset by peer"))) {
